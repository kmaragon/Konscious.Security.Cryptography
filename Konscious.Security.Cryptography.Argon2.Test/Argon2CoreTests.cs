...
namespace Konscious.Security.Cryptography
{
    ...
    public class Argon2CoreTests
    {
        ...
        [Fact]
        public void InitializeLanes_BuildsInitialLanesCorrectly()
        {
            var subject = new Argon2iCore(128);
            ...
            var actual = subject.InitializeLanes(Encoding.UTF8.GetBytes("P@ssw0rd!$"));
        ...
        [Fact]
        public void Hash_HashesAnArgon2dThingWithSalt()
        {
            ...
            var actual = subject.Hash(Encoding.UTF8.GetBytes("P@ssw0rd!$"));
            Assert.Equal(expected, actual);
        }

        [Fact]
        public void Hash_HashesAnArgon2iThingWithSalt()
        {
            var subject = new Argon2iCore(128);
