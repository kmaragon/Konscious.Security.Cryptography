...
internal class Blake2bAdvSimd : Blake2bBase
{
    public Blake2bAdvSimd(int HashBytes)
        : base(HashBytes)
    {
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void Compress(bool isFinal, Span<ulong> hashBuffer, ReadOnlySpan<byte> dataBuffer,
        ulong totalSegmentsLow, ulong totalSegmentsHigh)
    {
        ...
        unchecked
        {
            Vector256<byte> r24 = Vector256.Create((byte)3, 4, 5, 6, 7, 0, 1, 2, 11, 12, 13, 14, 15, 8, 9, 10, 3, 4, 5,
                6, 7, 0, 1, 2, 11, 12, 13, 14, 15, 8, 9, 10);
            Vector256<byte> r16 = Vector256.Create((byte)2, 3, 4, 5, 6, 7, 0, 1, 10, 11, 12, 13, 14, 15, 8, 9, 2, 3, 4,
                5, 6, 7, 0, 1, 10, 11, 12, 13, 14, 15, 8, 9);
            ...
            Vector256<ulong> row4 = Vector256.Create((ulong)0x510E527FADE682D1UL, 0x9B05688C2B3E6C1FUL,
